...
import { isDarkThemeMode } from "../utils";
import { alpha } from "@mui/material";

type ComponentsProps = ThemeOptions["components"];
...
export const useComponents = ({
  ...
  themeMode,
  typography,
}: useComponentsProps): ComponentsProps => {
  return useMemo(
    () => ({
      MuiCssBaseline: {
        styleOverrides: {
      ...
      MuiAlert: {
        ...
        styleOverrides: {
          ...
          standardSuccess: {
            color: darken(palette.success.main, 0.7),
            background: lighten(palette.success.main, 0.7),
          },
          standardWarning: {
            color: darken(palette.warning.main, 0.7),
            background: lighten(palette.warning.main, 0.7),
          },
          standardError: {
            color: darken(palette.error.main, 0.7),
            background: lighten(palette.error.main, 0.7),
          },
          standardInfo: {
            color: isDarkThemeMode(themeMode)
              ? lighten(palette.info.main, 0.7)
              : darken(palette.info.main, 0.7),
            background: isDarkThemeMode(themeMode)
              ? alpha(palette.info.main, 0.25)
      ...
      MuiBackdrop: {
        styleOverrides: {
          root: {
            backgroundColor: isDarkThemeMode(themeMode)
              ? "rgba(30, 30, 30, 0.5)"
      ...
      MuiButton: {
        ...
        styleOverrides: {
          root: {
            borderRadius: shape?.borderRadius,
            boxShadow: shadows[0],
            fontSize: typography?.body1?.fontSize || ".9375rem",
            fontWeight: 500,
            lineHeight: 1,
            "&.Mui-disabled": {
              opacity: 0.4,
          ...
          containedPrimary: {
            ...
            "&:hover, &:focus": {
              borderColor: darken(palette.primary.main, 0.1),
          ...
          containedSecondary: {
            ...
            color: palette.base.main,
            "&:hover, &:focus": {
              borderColor: darken(palette.secondary.main, 0.1),
          ...
          containedError: {
            backgroundColor: alpha(palette.error.main, 0.65),
            borderColor: alpha(palette.error.main, 0),
            color: palette.base.main,
            "&:hover, &:focus": {
              borderColor: darken(palette.error.main, 0.1),
      ...
      MuiButtonGroup: {
        ...
        styleOverrides: {
          ...
          groupedContainedPrimary: {
            "&:not(:last-of-type)": {
              borderColor: palette.primary.main,
              borderRight: `1px solid ${lighten(palette.primary.main, 0.3)}`,
              "&:hover, &:focus": {
                borderColor: darken(palette.primary.main, 0.1),
                backgroundColor: darken(palette.primary.main, 0.1),
              },
          ...
          groupedContainedSecondary: {
            "&:not(:last-of-type)": {
              borderColor: palette.secondary.main,
              borderRight: `1px solid ${lighten(palette.secondary.main, 0.3)}`,
              "&:hover, &:focus": {
                borderColor: darken(palette.secondary.main, 0.1),
                backgroundColor: darken(palette.secondary.main, 0.1),
              },
      ...
      MuiOutlinedInput: {
        ...
        styleOverrides: {
          root: {
            ...
            [`&.Mui-focused:not(.Mui-error):hover .${outlinedInputClasses["notchedOutline"]}`]: {
              borderColor: palette.primary.main,
            },
            "&.Mui-disabled": {
