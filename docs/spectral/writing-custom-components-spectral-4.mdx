---
id: writing-custom-components-spectral-4
title: Writing Custom Components with Spectral 4.x
description: Create custom Prismatic components using the Prismatic SDK with Spectral 4.x
sidebar_label: Spectral 4.x Docs
---
...
The `context` parameter is an object that contains five attributes: `logger`, `credential`, `executionId`, `instanceState`, and `stepId`.
