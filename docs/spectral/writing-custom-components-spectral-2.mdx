---
id: writing-custom-components-spectral-2
title: Writing Custom Components with Spectral 2.x
description: Create custom Prismatic components using the Prismatic SDK with Spectral 2.x
sidebar_label: Spectral 2.x Docs
---
...
An `action` takes three arguments:
...
This documentation references Spectral 2.x.
2.x was released to improve the developer experience and catch some common mistakes at compile time (rather than letting them manifest as runtime errors).
Spectral 2.x introduced enough changes to syntax from 1.x that a major version bump was necessary.

Spectral 1.x is still available, and you can keep components on 1.x if you prefer.
Source code from 1.x is available in a branch on [github](https://github.com/-io/spectral/tree/v1.x), and in-line documentation can guide you through component maintenance for an existing component that uses 1.x.
You can also reference [a version of this page](spectral/writing-custom-components-spectral-1.mdx) that covers Spectral 1.x syntax.
If you would like to upgrade an existing 1.x component to 2.x, please see our simple [Spectral 2.x upgrade guide](spectral/spectral-2-upgrade-guide.mdx).

If you are building a new component, we strongly encourage you to start with Spectral 2.x.
