...
id: components
title: Components
description: Prismatic components, actions, inputs, and outputs
---
...
For example, the [SFTP component](components/sftp.mdx) allows integrations to download and modify files on an SFTP server.
The [Slack component](components/slack.mdx) posts messages to Slack channels.

Several components are strung together to form an [integration](integrations.mdx).
...
### -provided components
 ...
 offers a wide array of components to accomplish a variety of things, like serializing data formats, invoking REST endpoints, or interacting with commonly-used SaaS platforms like AWS, Slack, or Dropbox - see our [component catalog](components/component-catalog.mdx) for a full list of components.
Source code for some -provided components is available on [GitHub](https://github.com/-io/examples/tree/main/components).
...
<Screenshot
  ...
  alt="List of components in  app"
/>

### Custom components

The majority of your integrations can likely be developed using -provided components.
For the portions of your integrations that are specific to your industry or product,  provides the ability to run your own code as part of your integration.
You can deploy your own code in the form of reusable [custom components](custom-components/code-vs-custom-components.mdx) or short [code component](components/code.mdx) steps.

**For More Information**:
[When Should I Use a Custom Component vs a Code Component?](custom-components/code-vs-custom-components.mdx#when-should-i-use-a-custom-component-vs-a-code-component)

## Component actions

Components contain one or more **actions** that can be invoked.
For example, the [Amazon S3 component](components/aws-s3.mdx) contains actions to copy S3 objects, delete objects, get an object's contents, etc.
...
**For More Information**:
[Custom Component Actions](custom-components/writing-custom-components.mdx#writing-actions)
...
<Screenshot
  ...
  alt="Component auth methods in  app"
/>
...
<Screenshot
  ...
  maxWidth="500px"
  alt="Component version drawer in  app"
/>
...
When your team publishes a new version of a custom component, or when  publishes a new version of a built-in component, you will see an notification in the integration designer on the **Component Versions** button indicating that some components are outdated.
...
**For More Information**:
[Choosing Component Versions](building-integrations.mdx#choosing-component-versions)
