...
description: In this quickstart we import an external library and generate a PDF using the Prismatic code component
---
...
Adding this `require()` line to the top of our code component will cause the code component to [dynamically import](code-component-usage.mdx#adding-dependencies-to-a-code-step) the PDF-LIB library as a dependency.
...
For more information on code components checkout the [code component usage](code-component-usage.mdx) page.
