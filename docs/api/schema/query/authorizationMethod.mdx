...
description: Learn how to use the authorizationMethod Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ----------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the AuthorizationMethod object. |

## Return fields ([AuthorizationMethod](api/schema/object/AuthorizationMethod.mdx))
...
###### <b>fields</b> ([CredentialFieldConnection!](api/schema/object/CredentialFieldConnection.mdx))
