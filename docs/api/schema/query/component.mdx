...
description: Learn how to use the component Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Component object. |

## Return fields ([Component](api/schema/object/Component.mdx))
