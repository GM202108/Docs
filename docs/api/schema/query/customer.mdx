...
description: Learn how to use the customer Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------------ |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Customer object. |

## Return fields ([Customer](api/schema/object/Customer.mdx))

###### <b>allowAddAlertMonitor</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Specifies whether the signed-in User can add an Alert Monitor to the Customer.

###### <b>allowAddComponent</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>allowAddInstance</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>externalId</b> ([String](api/schema/scalar/String.mdx))

Allows for mapping an external entity to a  record.
...
###### <b>org</b> ([Organization!](api/schema/object/Organization.mdx))
