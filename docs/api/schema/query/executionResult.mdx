...
description: Learn how to use the executionResult Query for Prismatic's API.
---
...
| -------- | --------------------------------- | --------------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the InstanceExecutionResult object. |

## Return fields ([InstanceExecutionResult](api/schema/object/InstanceExecutionResult.mdx))
