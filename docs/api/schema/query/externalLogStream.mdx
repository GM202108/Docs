...
description: Learn how to use the externalLogStream Query for Prismatic's API.
---
...
| -------- | --------------------------------- | --------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the ExternalLogStream object. |

## Return fields ([ExternalLogStream](api/schema/object/ExternalLogStream.mdx))
