...
description: Learn how to use the instanceDailyUsageMetric Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ----------------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the InstanceDailyUsageMetrics object. |

## Return fields ([InstanceDailyUsageMetrics](api/schema/object/InstanceDailyUsageMetrics.mdx))
