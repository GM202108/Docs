...
title: user Query
sidebar_label: user
description: Learn how to use the user Query for Prismatic's API.
---
...
| -------- | --------------------------------- | -------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the User object. |

## Return fields ([User](api/schema/object/User.mdx))

###### <b>allowChangeRoles</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>appAvatarUrl</b> ([String](api/schema/scalar/String.mdx))

The URL for the main avatar image that is displayed in .

###### <b>appName</b> ([String!](api/schema/scalar/String.mdx))

The app name displayed in .
...
###### <b>darkMode</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Designates whether the User has dark mode activated or not.

###### <b>darkModeSyncWithOs</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Designates whether dark mode should be derived from the operating system.

###### <b>dateJoined</b> ([DateTime!](api/schema/scalar/DateTime.mdx))

The date the User was created.

###### <b>email</b> ([String!](api/schema/scalar/String.mdx))
...
###### <b>phone</b> ([String!](api/schema/scalar/String.mdx))

The preferred contact phone number for the User.

###### <b>role</b> ([Role!](api/schema/object/Role.mdx))
