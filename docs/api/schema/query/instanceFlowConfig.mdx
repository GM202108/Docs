...
description: Learn how to use the instanceFlowConfig Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ---------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the InstanceFlowConfig object. |

## Return fields ([InstanceFlowConfig](api/schema/object/InstanceFlowConfig.mdx))
