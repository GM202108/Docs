...
description: Learn how to use the orgDailyUsageMetric Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------------------------ |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the OrgDailyUsageMetrics object. |

## Return fields ([OrgDailyUsageMetrics](api/schema/object/OrgDailyUsageMetrics.mdx))
