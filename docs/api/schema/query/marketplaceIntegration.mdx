...
description: Learn how to use the marketplaceIntegration Query for Prismatic's API.
---
...
| -------- | --------------------------------- | --------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Integration object. |

## Return fields ([Integration](api/schema/object/Integration.mdx))

###### <b>actions</b> ([IntegrationActionConnection!](api/schema/object/IntegrationActionConnection.mdx))

The Integration to which the IntegrationAction is associated via the IntegrationFlow.

###### <b>allowFork</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>allowMultipleMarketplaceInstances</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Specifies whether multiple Instances of this Integration may be created from the Marketplace.

###### <b>allowPublish</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>configPages</b> ([JSONString!](api/schema/scalar/JSONString.mdx))
...
###### <b>definition</b> ([String](api/schema/scalar/String.mdx))
...
###### <b>documentation</b> ([String](api/schema/scalar/String.mdx))

Rich text documentation to accompany the Integration.

###### <b>endpointConfigTestContentType</b> ([String](api/schema/scalar/String.mdx))

Content type of the payload for testing the endpoint configuration for this Integration.

###### <b>endpointConfigTestHeaders</b> ([JSONString](api/schema/scalar/JSONString.mdx))
...
###### <b>endpointConfigTestPayload</b> ([String](api/schema/scalar/String.mdx))

Data payload for testing the endpoint configuration for this Integration.

###### <b>endpointConfigTestUrl</b> ([String!](api/schema/scalar/String.mdx))

The URL of the endpoint that allows testing the endpoint configuration of the Integration.

###### <b>endpointType</b> ([IntegrationEndpointType](api/schema/enum/IntegrationEndpointType.mdx))
...
###### <b>flows</b> ([IntegrationFlowConnection!](api/schema/object/IntegrationFlowConnection.mdx))

The Integration of which the IntegrationFlow is a part.

###### <b>hasOutdatedComponents</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Specifies whether the Integration uses outdated Components

###### <b>hasUnpublishedChanges</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>instances</b> ([InstanceConnection!](api/schema/object/InstanceConnection.mdx))

The Integration that has been deployed for the Instance.

###### <b>isCustomerDeployable</b> ([Boolean](api/schema/scalar/Boolean.mdx))
...
###### <b>marketplaceConfiguration</b> ([MarketplaceConfiguration!](api/schema/enum/MarketplaceConfiguration.mdx))
...
###### <b>marketplaceTabConfiguration</b> ([[String!]](api/schema/scalar/String.mdx))
...
###### <b>systemInstance</b> ([Instance!](api/schema/object/Instance.mdx))

System Instance backing this Integration.

###### <b>templateConfiguration</b> ([IntegrationTemplateConfiguration!](api/schema/enum/IntegrationTemplateConfiguration.mdx))

Specifies whether the latest published version of this Integration may be used as a template to create new Integrations.

###### <b>testConfigVariables</b> ([InstanceConfigVariableConnection!](api/schema/object/InstanceConfigVariableConnection.mdx))
...
###### <b>useAsTemplate</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>versionAt</b> ([Integration](api/schema/object/Integration.mdx))
...
###### <b>versionSequence</b> ([IntegrationConnection!](api/schema/object/IntegrationConnection.mdx))
