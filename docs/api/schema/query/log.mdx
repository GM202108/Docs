...
title: log Query
sidebar_label: log
description: Learn how to use the log Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Log object. |

## Return fields ([Log](api/schema/object/Log.mdx))
