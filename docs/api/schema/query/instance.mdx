...
description: Learn how to use the instance Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------------ |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Instance object. |

## Return fields ([Instance](api/schema/object/Instance.mdx))

###### <b>allowDeploy</b> ([Boolean](api/schema/scalar/Boolean.mdx))
...
###### <b>allowUpdateConfigVariables</b> ([Boolean](api/schema/scalar/Boolean.mdx))

Specifies whether the signed-in User can update config variables for the Instance.

###### <b>configState</b> ([InstanceConfigState](api/schema/enum/InstanceConfigState.mdx))

Describes the state of configuration of this Instance.

###### <b>configVariables</b> ([InstanceConfigVariableConnection!](api/schema/object/InstanceConfigVariableConnection.mdx))
...
###### <b>deployedVersion</b> ([Int!](api/schema/scalar/Int.mdx))
...
###### <b>enabled</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>flowConfigs</b> ([InstanceFlowConfigConnection!](api/schema/object/InstanceFlowConfigConnection.mdx))
...
###### <b>isCustomerUpgradeable</b> ([Boolean](api/schema/scalar/Boolean.mdx))
...
###### <b>lastDeployedAt</b> ([DateTime](api/schema/scalar/DateTime.mdx))
...
###### <b>needsDeploy</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
Specifies whether the Instance has been suspended by .

###### <b>updatedAt</b> ([DateTime!](api/schema/scalar/DateTime.mdx))

The timestamp at which the object was most recently updated.

###### <b>userLevelConfigVariables</b> ([CustomUserLevelConfigVariableConnection](api/schema/object/CustomUserLevelConfigVariableConnection.mdx))

The User Level Config variables for the requesting User on this Instance.

###### <b>userLevelConfigs</b> ([UserLevelConfigConnection!](api/schema/object/UserLevelConfigConnection.mdx))
