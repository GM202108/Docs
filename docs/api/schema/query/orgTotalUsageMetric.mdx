...
description: Learn how to use the orgTotalUsageMetric Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ------------------------------------------ |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the OrgTotalUsageMetrics object. |

## Return fields ([OrgTotalUsageMetrics](api/schema/object/OrgTotalUsageMetrics.mdx))
...
###### <b>blobBytesStored</b> ([BigInt!](api/schema/scalar/BigInt.mdx))

The total number of bytes of blob storage currently used.

###### <b>customerCount</b> ([Int!](api/schema/scalar/Int.mdx))

The total number of Customers that currently exist.

###### <b>deployedInstanceCount</b> ([Int!](api/schema/scalar/Int.mdx))

The total number of Instances that are deployed.

###### <b>deployedUniqueIntegrationCount</b> ([Int!](api/schema/scalar/Int.mdx))
...
###### <b>integrationCount</b> ([Int!](api/schema/scalar/Int.mdx))

The total number of Integrations that currently exist.

###### <b>snapshotTime</b> ([DateTime!](api/schema/scalar/DateTime.mdx))

The time the utilization metrics snapshot was created.

###### <b>userCount</b> ([Int!](api/schema/scalar/Int.mdx))
