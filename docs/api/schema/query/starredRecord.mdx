...
description: Learn how to use the starredRecord Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ----------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the StarredRecord object. |

## Return fields ([StarredRecord](api/schema/object/StarredRecord.mdx))
