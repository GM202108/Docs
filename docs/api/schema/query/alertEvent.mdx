...
description: Learn how to use the alertEvent Query for Prismatic's API.
---
...
| -------- | --------------------------------- | -------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the AlertEvent object. |

## Return fields ([AlertEvent](api/schema/object/AlertEvent.mdx))
