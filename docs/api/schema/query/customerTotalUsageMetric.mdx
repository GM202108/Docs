...
description: Learn how to use the customerTotalUsageMetric Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ----------------------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the CustomerTotalUsageMetrics object. |

## Return fields ([CustomerTotalUsageMetrics](api/schema/object/CustomerTotalUsageMetrics.mdx))
