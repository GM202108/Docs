...
description: Learn how to use the action Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ---------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the Action object. |

## Return fields ([Action](api/schema/object/Action.mdx))
