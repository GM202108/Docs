...
description: Learn how to use the alertWebhook Query for Prismatic's API.
---
...
| -------- | --------------------------------- | ---------------------------------- |
| `id`     | [`ID!`](api/schema/scalar/ID.mdx) | The ID of the AlertWebhook object. |

## Return fields ([AlertWebhook](api/schema/object/AlertWebhook.mdx))
