...
description: Learn how to use the validateIntegrationSchema Mutation for Prismatic's API.
---
...
## Input fields ([ValidateIntegrationSchemaInput!](api/schema/input_object/ValidateIntegrationSchemaInput.mdx))
...
## Return fields ([ValidateIntegrationSchemaPayload](api/schema/object/ValidateIntegrationSchemaPayload.mdx))
