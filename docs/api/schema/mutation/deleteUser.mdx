...
description: Learn how to use the deleteUser Mutation for Prismatic's API.
---
...
## Input fields ([DeleteUserInput!](api/schema/input_object/DeleteUserInput.mdx))
...
## Return fields ([DeleteUserPayload](api/schema/object/DeleteUserPayload.mdx))
