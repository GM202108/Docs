...
description: Learn how to use the InputField Object for Prismatic's API.
---
...
###### <b>action</b> ([Action](api/schema/object/Action.mdx))
...
###### <b>collection</b> ([InputFieldCollection](api/schema/enum/InputFieldCollection.mdx))

Specifies the type of collection to use for storing input values, if applicable.

###### <b>comments</b> ([String](api/schema/scalar/String.mdx))
...
###### <b>default</b> ([String](api/schema/scalar/String.mdx))

The default value for the InputField.

###### <b>example</b> ([String](api/schema/scalar/String.mdx))
...
###### <b>keyLabel</b> ([String](api/schema/scalar/String.mdx))
...
###### <b>language</b> ([String](api/schema/scalar/String.mdx))

Language to use for the Code Field.

###### <b>model</b> ([JSONString](api/schema/scalar/JSONString.mdx))

Dictates how possible choices are provided for this InputField.

###### <b>placeholder</b> ([String](api/schema/scalar/String.mdx))

Placeholder text that will appear in the InputField UI.

###### <b>required</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Specifies whether the InputField is required by the Action.

###### <b>shown</b> ([Boolean!](api/schema/scalar/Boolean.mdx))

Specifies whether the InputField is shown in the Designer.

###### <b>type</b> ([InputFieldType!](api/schema/enum/InputFieldType.mdx))
