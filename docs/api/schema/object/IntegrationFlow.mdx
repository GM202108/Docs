...
description: Learn how to use the IntegrationFlow Object for Prismatic's API.
---
...
###### <b>endpointSecurityType</b> ([IntegrationFlowEndpointSecurityType!](api/schema/enum/IntegrationFlowEndpointSecurityType.mdx))
...
###### <b>isSynchronous</b> ([Boolean!](api/schema/scalar/Boolean.mdx))
...
###### <b>testExecutionResults</b> ([InstanceExecutionResultConnection!](api/schema/object/InstanceExecutionResultConnection.mdx))
...
###### <b>testUrl</b> ([String!](api/schema/scalar/String.mdx))

The URL of the endpoint that triggers execution of the Integration Flow in the Test Runner.

###### <b>trigger</b> ([IntegrationAction!](api/schema/object/IntegrationAction.mdx))
