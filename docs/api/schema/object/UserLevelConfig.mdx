...
description: Learn how to use the UserLevelConfig Object for Prismatic's API.
---
...
###### <b>configVariables</b> ([UserLevelConfigVariableConnection!](api/schema/object/UserLevelConfigVariableConnection.mdx))
...
###### <b>flowConfigs</b> ([UserLevelFlowConfigConnection!](api/schema/object/UserLevelFlowConfigConnection.mdx))
