...
description: Learn how to use the IntegrationAction Object for Prismatic's API.
---
...
###### <b>errorHandlerType</b> ([IntegrationActionErrorHandlerType](api/schema/enum/IntegrationActionErrorHandlerType.mdx))
...
###### <b>retryDelaySeconds</b> ([Int](api/schema/scalar/Int.mdx))

Specifies the delay in seconds between retry attempts for failures of this IntegrationAction.

###### <b>retryIgnoreFinalError</b> ([Boolean](api/schema/scalar/Boolean.mdx))
