...
description: Learn how to use the CredentialField Object for Prismatic's API.
---
...
###### <b>authorizationMethod</b> ([AuthorizationMethod!](api/schema/object/AuthorizationMethod.mdx))
...
###### <b>type</b> ([CredentialFieldType!](api/schema/enum/CredentialFieldType.mdx))
