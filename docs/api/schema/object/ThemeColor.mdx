...
description: Learn how to use the ThemeColor Object for Prismatic's API.
---
...
###### <b>type</b> ([ThemeColorType!](api/schema/enum/ThemeColorType.mdx))
...
###### <b>variant</b> ([ThemeColorVariant!](api/schema/enum/ThemeColorVariant.mdx))
