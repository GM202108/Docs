...
description: Prismatic's embedded integration marketplace allows your customers to discover all your integrations. Learn how to install the embedded integration marketplace.
---
