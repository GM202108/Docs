...
id: organization
title: Organization
description: Create and manage your Prismatic organization
---
...
In order to disambiguate who 's customers are, and who your customers are, we refer to 's customers as **organizations** and your customers as **customers**.
...
Your team members can be assigned [roles](users.mdx#organization-team-member-roles), so your DevOps team members might have administrator access, while your support team might have permission to review integration logs.

## Creating your organization

To create an organization within , first <InternalLink href="/sign-up/">sign up</InternalLink>.
...
Registering with  again will create a second organization.
:::
...
You can also view your organization's utilization of  resources.
...
<Screenshot
  ...
  alt="Change logo for org in  app"
/>
...
To update your organization's name programmatically, use the [updateOrganization](api/schema/mutation/updateOrganization.mdx) mutation:
...
After creating your organization, you can create [accounts](users.mdx#organization-users) for your team members so that they can create and maintain integrations for your customers.
...
Select an appropriate [role](users.mdx#organization-team-member-roles) for your team member, and enter their name and email address.
...
**For More Information**: [Users](users.mdx)
...
If your team members sign in to other applications through Active Directory, Active Directory Federation Services (ADFS), or Lightweight Directory Access Protocol (LDAP), then we can configure your organization to sign in to  the same way.
...
If you are interested in using Single Sign-On for , please reach out to our [support](mailto:support@.io) team to get SSO configured and enabled for your organization.
...
An [alert group](monitoring-and-alerting.mdx#alert-groups) is a set of users to notify and webhooks to invoke when an [alert trigger](monitoring-and-alerting.mdx#alert-triggers) fires.
...
<Screenshot
  ...
  alt="Create alert groups in  app"
/>

**For More Information**: [Monitoring and Alerting](monitoring-and-alerting.mdx)
...
See the [Embedding Marketplace](embedding-marketplace.mdx#theming-embedded-marketplace) article for information on custom theming.

## Tracking service utilization

You can track metrics about your organization's usage of  services from the **Utilization** tab of the **Settings** page.
...
<Screenshot
  ...
  alt="Track organization usage of services in  app"
/>

## Managing billing

When you first sign up for , you are entered into the "free plan" so you can try assembling and deploying a few integrations before paying for it.
...
<Screenshot
  ...
  alt="Manage organization billing in  app"
/>
...
As an organization with an <InternalLink href="/pricing/">Enterprise plan</InternalLink>, you can choose to interact with the  platform through a custom domain that you control.
For example, you might want to white-label  so your team members and customers access **https<!---->://integrations.your-company.com** instead of [https://app..io](https://app..io/).

To configure a custom domain, please reach out to our [support team](mailto:support@.io), and let us know what subdomain (like https<!---->://integrations.your-company.com) you would like to use.
...
- https<!---->://**hooks.integrations**.your-company.com
- https<!---->://**oauth2.integrations**.your-company.com
