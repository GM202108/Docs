...
description: You may host Prismatic integrations in multiple regions or in your private cloud. Here's how you manage integrations across multiple regions.
---
