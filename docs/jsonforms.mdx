...
This article describes how JSON Forms can be used in the [configuration wizard](configuration-wizard.mdx) to provide your customers a tailored deployment experience.
