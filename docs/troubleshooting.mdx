...
description: Troubleshooting integrations, common error messages, and how to fix them
---
...
serializes step results using [MessagePack](https://msgpack.org/index.html).
