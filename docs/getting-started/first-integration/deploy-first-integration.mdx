...
Now that you've [built your first integration](getting-started/first-integration/build-first-integration.mdx), let's deploy the integration to a customer.
...
Your software company has [customers](customers.mdx).
...
Since  charges per deployed instance, and free accounts have a limit of 4 deployed instances, you probably want to delete this instance.
...
In the next page you'll learn how to productize your integration and [prepare it for marketplace](getting-started/first-integration/prepare-for-marketplace.mdx).
