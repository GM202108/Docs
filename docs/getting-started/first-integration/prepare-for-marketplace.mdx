...
title: "Prepare Your Integration for Marketplace"
...
In this step you'll prepare the [integration you created](getting-started/first-integration/build-first-integration.mdx) for the [integration marketplace](integration-marketplace.mdx).
Once the integration has been added to your integration marketplace, your customers can activate it for themselves.
The can do that by logging in to using [customer users](users.mdx#customer-users), or if you [embed the marketplace](embedding-marketplace.mdx) in your app, they can activate the integration without leaving your app.
...
Click the **Description** button at the top of your integration and give your integration a category and description.
...
Click the **Config Page** button within your integration again to open the Config Wizard.
...
Click **Marketplace** on the left-hand sidebar and select **+ Add integration** from the top right.
...
Select your published integration from this list, click **Reconfigure**, and then give your marketplace offering an **Overview**:
...
Now, you can either [add customer users](users.mdx#customer-users) to and let them activate this integration, or you can [embed marketplace](embedding-marketplace.mdx) in your own app so users can seamlessly activate integrations without having to leave your app.
...
- Modify your integration to use [additional components](components/component-catalog.mdx).
- Write [your own component](custom-components/code-vs-custom-components.mdx) to accomplish industry-specific business logic for your company.
<!-- - Continue with the next few getting started guides, which cover more advanced topics like webhooks and custom component development. -->
