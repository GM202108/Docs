...
description: Prismatic's embedded designer allows your customers to build their own integrations with your product. Learn how to install the embedded integration designer.
---
